...
$route['panel/admin/login'] = 'Loginadmincontroller';
$route['dashboard/admin'] = 'Dashboardadmincontroller';

$route['dashboard/admin/schremblewords/add'] = 'Schremblewordcontroller';
$route['dashboard/admin/schremblewords/list'] = 'Schremblewordcontroller/listview';
...
$route['dashboard/admin/data/soal/list'] = 'soalcontroller';
